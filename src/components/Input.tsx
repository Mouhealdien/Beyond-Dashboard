...
const Input = ({ inputProps, label, disable, value }: props) => {
	return (
		<label
			className={`relative w-full block bg-white my-4 px-3 pt-3 overflow-hidden rounded-md border border-gray-200 shadow-sm focus-within:border-secondary focus-within:ring-1 focus-within:ring-secondary${
				disable ? ` bg-gray-200` : ``
			}`}
		>
			<input
